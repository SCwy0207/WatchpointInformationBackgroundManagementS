package com.wzcampus.cms.common.cache;

import com.wzcampus.cms.common.util.ObjectUtil;
import com.wzcampus.cms.common.util.RedisUtil;
...
public class CacheAspect {
    ...
    @Pointcut("execution(* com.briup.cms.service..*.*(..)) " +
            "&& @annotation(com.wzcampus.cms.common.cache.Cached)")
     ...
     */
    @Pointcut("execution(* com.briup.cms.service..*.*(..)) " +
            "&& @annotation(com.wzcampus.cms.common.cache.FlushCache)")
